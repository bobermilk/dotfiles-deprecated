...
require("presence"):setup({
    ...
    neovim_image_text   = "ayo you actin kinda sus", -- Text displayed when hovered over the Neovim image
    ...
    buttons = {
        { label = "yes, i'm a simp", url = "https://media.discordapp.net/attachments/883711473795354634/901534284299505744/im_simp.mp4" },
        { label = "get rickrolled", url = "https://media.discordapp.net/attachments/860234273198309396/900432201043304488/video0.mp4" }
    },
